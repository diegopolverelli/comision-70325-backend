...
// https://forms.gle/YmC8XkoR1KRjm5NSA


// Enlace a reposiorio GitHub:
// https://github.com/diegopolverelli/comision-70325-backend
...
<br><br>
<div id="datos"></div>
<button id="btnDatos">Obtener datos</button>
*/

// solicitar datos BEARER TOKEN con JS:
...
// Login: envío de email / password vía JS:
...
btnSubmit.addEventListener("click", async(e)=>{
    e.preventDefault()
    if(inputEmail.value.trim()===0 || inputPassword.value.trim()===0){
