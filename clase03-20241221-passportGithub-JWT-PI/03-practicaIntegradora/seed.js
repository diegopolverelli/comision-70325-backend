...
const creaData=async()=>{
    let resultado=await mongoose.connection.collection("heroes").drop()
    console.log(resultado)
    resultado=await mongoose.connection.collection("heroes").insertMany(heroes)
    console.log(resultado)
    resultado=await mongoose.connection.collection("villanos").drop()
    console.log(resultado)
